...
function Profile(props) {
    ...
    return (
        <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",borderRadius:10,width:400,margin:"auto",background:"white" }}>
            <div style={{backgroundColor:"#e74c3c",borderTopLeftRadius:"10px" ,borderTopRightRadius:"10px",width:"100%",height:"150px",display:"flex",justifyContent:"center",alignItems:"center"}}>
            {props.children}
            </div>
